...
class Card {
    ...
    rightSlide(btn) {
        ...
        let pixels = parseInt(imagesContainer.dataset.pixels);
        pixels == 66 ? pixels = 0 : pixels += 33;
        imagesContainer.dataset.pixels = pixels
        imagesContainer.style.transform = `translate(-${pixels}%, 0px)`
                ...
                <li class="es-card" data-id="${id}">
                    <div class="es-card__slider">
                        <div class="es-card__slider-buttons">
                            <button class="es-btn-slider es-card__slider-btn-left" id="btn-left" onclick="card.leftSlide(this)">
                            ...
                            <button class="es-btn-slider es-card__slider-btn-right" id="btn-right" onclick="card.rightSlide(this)">
                        ...
                        <div class="es-card__slider-container">
                            <div class="es-card__slider-list" data-pixels="0">
                    ...
                    <div class="es-card__info">
                        <div>
                            <h3 class="es-title--h3 es-card__title"><a href="/product-page.html" target="_blank" onclick="saveСardId(this)" onauxclick="saveСardId(this)" data-id="${id}">${title}</a></h3>
                            <p class="es-card__description">${description}</p>
                            <p class="es-card__description">В наличии: ${inStock}</p>
                        </div>

                        <div class="es-margin-top">
                            <div class="es-counter es-card__counter" data-id="${id}">
                                <div class="es-counter__content">
                                    <button class="es-counter__arrow es-counter__arrow-1" onclick="minusNumber(this), addToCart(), addLocalStorageProductsToCartPage()">
                                    ...
                                    <button class="es-counter__arrow es-counter__arrow-2" onclick="plusNumber(this), addToCart(), addLocalStorageProductsToCartPage()">
                            ...
                            <div class="es-card__buttons">
                                ...
                                <button class="es-btn-chosen es-btn-chosen--hover es-margin-left" onclick="card.addToLocalStorageChosen(this), udateQuantityProductsOnChosenBtn(), addChosenProducts()">
